...
static const wchar_t* th19_names[20][2] = {
	...
	{ L"Sanae", L"Sanae Kochiya" },
	{ L"Ran", L"Ran Yakumo" },
	{ L"Aun", L"Aun Komano" },
	{ L"Nazrin", L"Nazrin" },
	{ L"Seiran", L"Seiran" },
	{ L"Rin", L"Rin Kaenbyou" },
	{ L"Tsukasa", L"Tsukasa Kudamaki" },
	{ L"Mamizou", L"Mamizou Futatsuiwa" },
	{ L"Yachie", L"Yachie Kicchou" },
	{ L"Saki", L"Saki Kurokoma" },
	{ L"Yuuma", L"Yuuma Toutetsu" },
	{ L"Suika", L"Suika Ibuki" },
	{ L"Biten", L"Biten Son" },
	{ L"Enoko", L"Enoko Mitsugashira" },
	{ L"Chiyari", L"Chiyari Tenkajin" },
	{ L"Hisami", L"Hisami Yomotsu" },
	{ L"Zanmu", L"Zanmu Nippaku" },
	{ L"anyone", L"anyone" },
};
